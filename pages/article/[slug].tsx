...
import { fetchArticleBySlug, fetchCategories } from '../../http'
...
const slug = ({ categories, article }: IPropType) => {
    return (
        <>
            <Head>
            ...
            <Tabs categories={categories.items} handleOnSearch={function (query?: string | undefined): void {
                throw new Error('Function not implemented.')
            }} />

            <div className='my-12 grid lg:grid-cols-3 grid-cols-1 gap-12 single-article'>
